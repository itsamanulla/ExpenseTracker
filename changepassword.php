  ...
  <body>
          ...
          <div class="col-md-2">
            <nav >
                <ul class="navi">
                  ...
                  <li><a href=""><i class="fa fa-sign-out" style="font-size:18px;color:black;"></i>&nbsp; Logout</a> </li>
                </ul>
              </nav>
        </div>
    ...
    <div class="col-md-4 mt-4">
        ...
        <form action="update_pass.php" method="post" >
            <label style="font-size: 30px; color: rgb(0 0 0 / 45%)">Change Password</label>
            <div class="form-group">
                <label for="curr">Current Password</label>
                <input type="password" name="curr" class="form-control" id="curr">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" name="conf" class="form-control" id="conf" >
              </div>
